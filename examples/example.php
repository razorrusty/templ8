...
$main_template = \helical\templ8\parse::from_file('templates/default.html', $keywords, true);	
$inner_template = \helical\templ8\parse::from_string('<h2>This is some custom output</h2><p>[{}message]</p>', $keywords2, '{}');	
